export default function CustomTooltip({ content, children }: any) {
    return (
        <div className="group relative inline-block">
            {children}
            <div className="absolute top-full left-1/2 -translate-x-1/2 mb-2 p-2 px-3 bg-gray-800 text-white text-sm rounded opacity-0 group-hover:opacity-50 transition-opacity duration-300 mt-3">
                {content}
