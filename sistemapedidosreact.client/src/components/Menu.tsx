...
export default function Menu({items, title}: any) {
    ...
    return (
        <section className="menu__carrousel my-3 mb-5">
            ...
            <div className="menu__container relative">
                ...
                {items?.length > 1 && <BsArrowRightCircleFill className="hidden lg:block arrow arrow-right" onClick={scrollRight}></BsArrowRightCircleFill>}
            </div>
        </section>
    )
}